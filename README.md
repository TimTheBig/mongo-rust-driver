...
| `rustls-tls`         | Use [`rustls`](https://docs.rs/rustls/latest/rustls/) for TLS connection handling, with the `ring` crypto provider. **Enabled by default.**               
| `rustls-tls-aws-lc`         | Use [`rustls`](https://docs.rs/rustls/latest/rustls/) for TLS connection handling, with the `aws-lc-rs` crypto provider.                                                                                                        |
